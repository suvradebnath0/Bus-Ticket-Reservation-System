...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"ENA Express","HANIF Express","SHYMOLI Express","GREEN_LINE Express","ROYEL Express","DHAKA Express"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
printf("\n\t\t\t\tThe Total booking amount is %d Taka",400*booking);
itoa(seat1, str1, 10);
...
printf("\n\n");
    printf("======================================================================================================\n");
 printf("\t\t\t\tYour 400 Taka has been Returned\t\t\t\n");
    printf("======================================================================================================\n");
}
void about()
{
    ...
    printf("\n");
    printf("    :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::\n");
    printf("    ::                              Project Name : Bus Ticket Reservation System(BTRS)                           ::\n");
    printf("    ::                             ---------------------------------------------------                           ::\n");
    printf("    ::                                                                                                           ::\n");
    printf("    ::                                          ----------------------                                           ::\n");
    printf("    ::                                               Submitted By                                                ::\n");
    printf("    ::                                          ----------------------                                           ::\n");
    printf("    ::                                     Name : Suvra Debnath                                                  ::\n");
    printf("    ::                                ID Number : 0242220005341067                                               ::\n");
    printf("    ::                                    Batch : 39th                                                           ::\n");
    printf("    ::                                  Section : A                                                              ::\n");
    ...
    printf("    ::                                                                                                           ::\n");
    printf("    ::                        Copyright | 2023 - Sauvra Debnath. All Right Reserved.                             ::\n");
    printf("    :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::\n");
